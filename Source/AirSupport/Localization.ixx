...
export namespace Localization
{
	inline namespace Keys
	{
		...
		inline constexpr char REJECT_HEIGHT_NOT_ENOUGH[] = "#AIRSUPPORT_REJECT_HEIGHT_NOT_ENOUGH";
		...
		inline constexpr char HINT_PRESS_AND_HOLD[] = "#AIRSUPPORT_HINT_PRESS_AND_HOLD";
	};
	...
	namespace L_EN
	{
		...
		inline constexpr char REJECT_HEIGHT_NOT_ENOUGH[] = "The location is too elevated! (%s1)";
		...
		inline constexpr char HINT_PRESS_AND_HOLD[] = "PRESS and HOLD to direct the bombardment.";
	};
	...
	namespace L_CH
	{
		...
		inline constexpr char REJECT_HEIGHT_NOT_ENOUGH[] = u8"地形崎嶇故無法轟炸 (%s1)";
		...
		inline constexpr char HINT_PRESS_AND_HOLD[] = u8"按住左鍵以調整轟炸方向";
	};
};
